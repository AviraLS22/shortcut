...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._f1_range = qtgui.Range(10, 20000, 1, 50, 200)
        self._f1_win = qtgui.RangeWidget(self._f1_range, self.set_f1, "'f1'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f1_win)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 50, 5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 50, 5, 0, 0)
