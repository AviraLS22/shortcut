...
class eyePlot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "eyePlot")
        ...
        self.blocks_delay_2 = blocks.delay(gr.sizeof_gr_complex*1, (delay*3))
        self.blocks_delay_1 = blocks.delay(gr.sizeof_gr_complex*1, (delay*2))
    ...
    def set_delay(self, delay):
        ...
        self.blocks_delay_1.set_dly(int((self.delay*2)))
        self.blocks_delay_2.set_dly(int((self.delay*3)))




def main(top_block_cls=eyePlot, options=None):
